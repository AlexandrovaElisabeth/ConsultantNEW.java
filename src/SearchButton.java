...
public class SearchButton implements ActionListener {
     ...
     *  3. Добавляет в новое окно панель прокрутки с фотографиями, на которых изображены выбранные предметы одежды.
     *  4. Масштабирует фотографии по высоте, чтобы они помещались в панель прокрутки.
     *  5. Отображает новое окно "Подобранные типы одежды".
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //Делаем главное окно видимым при закрытии текущего окна
